...
$(window).on("load", function(){
	for (var key in newsFeeds) {
		$('#center').append('<div class="d2x2 newsFeed"><h1><a href="'+newsFeeds[key].SiteUrl+'" class="bracket">'+newsFeeds[key].Title+'</a></h1><div class="d2x2Child newsFeedContent" id="'+key+'"></div></div>');
		$('#'+key).FeedEk( {
